// lib/screens/otp_screen_with_provider.dart
// EXEMPLE DE MIGRATION VERS PROVIDER
// Ce fichier montre comment migrer otp_screen.dart pour utiliser UserSessionProvider
...
class OTPScreenWithProvider extends StatefulWidget {
  final String phone;

  const OTPScreenWithProvider({
    super.key,
    required this.phone,
  });

  @override
  State<OTPScreenWithProvider> createState() => _OTPScreenWithProviderState();
}

class _OTPScreenWithProviderState extends State<OTPScreenWithProvider> with CodeAutoFill {
